...
void CalculateDensityField(double *fphys,int*pE3d,int MyID) {
...
#pragma omp parallel for num_threads(DG_THREADS)
	...
	Exchange(BaroclinicT, IEFToE, pE3d, IENe, Np, K, 1);// use MPI to exchange 3d message
	Exchange(BaroclinicS, IEFToE, pE3d, IENe, Np, K, 1);// use MPI to exchange 3d message
	Limiter3d(BaroclinicT, pE3d, MyID);
	Limiter3d(BaroclinicS, pE3d, MyID);
